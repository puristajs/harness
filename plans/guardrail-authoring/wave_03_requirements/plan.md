# Wave 3: Provider-neutral interceptor build preflight

Owns TICKET-003; dependency: TICKET-002. Execute its contract/test/implementation/verification sequence. End in a working public-interface slice with all three acceptance paths and independent review. Release remains blocked until final integration. No parallel writes in this wave.
