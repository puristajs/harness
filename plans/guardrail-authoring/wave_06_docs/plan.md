# Wave 6: Harness guides, examples and canonical skill alignment

Owns TICKET-006; dependency: TICKET-005. Execute its contract/test/implementation/verification sequence. End in a working public-interface slice with all three acceptance paths and independent review. Release remains blocked until final integration. No parallel writes in this wave.
