# Wave 8: Consumer cut, removal gates and final acceptance

Owns TICKET-008; dependency: TICKET-007. Execute its contract/test/implementation/verification sequence. End in a working public-interface slice with all three acceptance paths and independent review. Release remains blocked until final integration. No parallel writes in this wave.
