---
id: TICKET-006
title: Aggregate durable partitions checkpoint pins and terminal lifecycle
wave: 5
lifecycle: planned
...
parallel_group: serial-TICKET-006
depends_on: [TICKET-005]
blocked_by: [TICKET-005]
spec_refs: [ai-harness/specs/36-sandbox-ownership-and-administration/00-vision.md#REQ-SOWN-DURABLE, ai-harness/specs/36-sandbox-ownership-and-administration/00-vision.md#REQ-SOWN-OWNER, ai-harness/specs/36-sandbox-ownership-and-administration/00-vision.md#REQ-SOWN-BOUNDS, ai-harness/specs/36-sandbox-ownership-and-administration/03-contracts/api.md#CTR-SOWN-WORKSPACE, ai-harness/specs/36-sandbox-ownership-and-administration/03-contracts/api.md#CTR-SOWN-OWNER, ai-harness/specs/36-sandbox-ownership-and-administration/03-contracts/api.md#CTR-SOWN-OPEN, ai-harness/specs/36-sandbox-ownership-and-administration/03-contracts/api.md#CTR-SOWN-ERRORS, ai-harness/specs/36-sandbox-ownership-and-administration/04-delivery.md#DEC-SOWN-DELIVERY]
write_scope: [ai-harness/packages/harness/src/ports/workspace.ts, ai-harness/packages/harness/src/runtime/sessionDurable.ts, ai-harness/packages/harness/src/runtime/sandboxCheckpoint.ts, ai-harness/packages/harness/src/sessions/index.ts, ai-harness/packages/harness/src/local/local-workspace.ts, ai-harness/packages/harness/src/local/local-sandbox-state.ts, ai-harness/packages/harness/src/local/local-sandbox.ts, ai-harness/packages/harness/src/local/index.ts, ai-harness/packages/harness/src/testing, ai-harness/packages/harness/test/sandbox-durable-partitions.test.ts, ai-harness/packages/harness/test/local-durable-execution.test.ts, ai-harness/packages/harness/test/local-sandbox-workspace-isolation.test.ts, ai-harness/packages/harness/test/durable-session.test.ts, ai-harness/packages/harness/test/durable-steps.test.ts, ai-harness/packages/harness/src/workspace, ai-harness/packages/harness/src/ports/workspace.test.ts, ai-harness/packages/harness/src/runtime/steps.ts]
...
contract_readiness:
  status: ready
  required_contracts: [CTR-SOWN-WORKSPACE, CTR-SOWN-OWNER, CTR-SOWN-OPEN, CTR-SOWN-ERRORS]
  missing_contracts: []
traceability:
  requirement_ids: [REQ-SOWN-DURABLE, REQ-SOWN-OWNER, REQ-SOWN-BOUNDS]
  capability_ids: [CAP-SOWN-DURABLE, CAP-SOWN-OWNER, CAP-SOWN-BOUNDS]
  path_ids: [PATH-SOWN-DURABLE, PATH-SOWN-OWNER, PATH-SOWN-BOUNDS]
  acceptance_ids: [ACC-SOWN-DURABLE, ACC-SOWN-OWNER, ACC-SOWN-BOUNDS]
generated_contracts:
  status: ready
  source_refs: [ai-harness/specs/36-sandbox-ownership-and-administration/03-contracts/api.md#CTR-SOWN-WORKSPACE, ai-harness/specs/36-sandbox-ownership-and-administration/03-contracts/api.md#CTR-SOWN-OWNER, ai-harness/specs/36-sandbox-ownership-and-administration/03-contracts/api.md#CTR-SOWN-OPEN, ai-harness/specs/36-sandbox-ownership-and-administration/03-contracts/api.md#CTR-SOWN-ERRORS]
  command_refs: []
...
representation_reuse:
  ...
  shape_refs: [sown.checkpoint, sown.scope, sown.owner, sown.safe-error]
  mapping_refs: []
...
action_steps:
  - id: STEP-PREFLIGHT
    ...
    acceptance_refs: [AC-TICKET-006-DURABLE, AC-TICKET-006-OWNER, AC-TICKET-006-BOUNDS]
  ...
  - id: STEP-CONTRACT
    kind: contract
    files: [ai-harness/specs/36-sandbox-ownership-and-administration/03-contracts/api.md, ai-harness/packages/harness/src/ports/workspace.ts]
  ...
  - id: STEP-TEST
    kind: test
    files: [ai-harness/packages/harness/test/sandbox-durable-partitions.test.ts, ai-harness/packages/harness/test/local-durable-execution.test.ts, ai-harness/packages/harness/test/local-sandbox-workspace-isolation.test.ts]
  ...
  - id: STEP-IMPLEMENT
    kind: implement
    files: [ai-harness/packages/harness/src/ports/workspace.ts, ai-harness/packages/harness/src/runtime/sessionDurable.ts, ai-harness/packages/harness/src/runtime/sandboxCheckpoint.ts, ai-harness/packages/harness/src/sessions/index.ts, ai-harness/packages/harness/src/local/local-workspace.ts, ai-harness/packages/harness/src/local/local-sandbox-state.ts, ai-harness/packages/harness/src/local/local-sandbox.ts, ai-harness/packages/harness/src/local/index.ts, ai-harness/packages/harness/src/testing, ai-harness/packages/harness/test/sandbox-durable-partitions.test.ts, ai-harness/packages/harness/test/local-durable-execution.test.ts, ai-harness/packages/harness/test/local-sandbox-workspace-isolation.test.ts, ai-harness/packages/harness/test/durable-session.test.ts, ai-harness/packages/harness/test/durable-steps.test.ts, ai-harness/packages/harness/src/workspace, ai-harness/packages/harness/src/ports/workspace.test.ts, ai-harness/packages/harness/src/runtime/steps.ts]
    command_refs: [CMD-HARNESS_TEST, CMD-HARNESS_PUBLIC_TYPES, CMD-HARNESS_TYPES]
    acceptance_refs: [AC-TICKET-006-DURABLE, AC-TICKET-006-OWNER, AC-TICKET-006-BOUNDS]
...
acceptance:
  - id: AC-TICKET-006-DURABLE
    ...
    test_refs: [ai-harness/packages/harness/test/sandbox-durable-partitions.test.ts, ai-harness/packages/harness/test/local-durable-execution.test.ts, ai-harness/packages/harness/test/local-sandbox-workspace-isolation.test.ts]
    command_refs: [CMD-HARNESS_TEST, CMD-HARNESS_PUBLIC_TYPES, CMD-HARNESS_TYPES]
...
# TICKET-006 — Aggregate durable partitions checkpoint pins and terminal lifecycle
...
Scope is the approved spec-36 follow-up, not the historical spec-34 completion. Current source baseline includes preserved uncommitted sandbox and unrelated evaluation/handbook work. Do not start until TICKET-005 are independently accepted and the controller promotes this ticket. Planning approval is not permission to implement during the current conversation.

## Implementation Approach

1. Make every durable invocation run-scoped and reject explicit borrowed owners before admission. Keep isolated background tasks ephemeral under their existing recovery-required contract.

2. Create aggregate partition subdirectories and external owner marker/epoch; no guest gets the aggregate root. Persist full durable policy digest and sorted captured partition membership.

3. Implement run-wide quiescence, serialized commit, writer admission barrier, candidate pin before publication, old-pin release after success, and storage-authoritative crash reconciliation.

4. Implement whole-run fencing before restore, committed-member corruption detection and authorized rollback of post-checkpoint partitions. Add workspace finish terminal state/time after persisted result and writer stop; release pins last.
...
2. Contract: trace CTR-SOWN-WORKSPACE, CTR-SOWN-OWNER, CTR-SOWN-OPEN, CTR-SOWN-ERRORS into the first owned source module and existing public exports. Compiler-generated declarations are not handwritten; strict DTO schemas and inferred types are source.
...
Restart recovery for private/group files; concurrent commit/unjoined child/spawn writer conflicts; external owner rejection; failed copy/publication/restore; partition absent-at-checkpoint replay versus missing committed files; digest drift; suspension and terminal pin ordering. Run the listed test files before the behavior change, then after; record exact red and green results. Include cancellation/denial/retry/state-loss assertions and content-free error projection when those paths are in scope.
...
Catalog: ai-harness/specs/36-sandbox-ownership-and-administration/03-contracts/representation-catalog.yaml. Reuse sown.checkpoint, sown.scope, sown.owner, sown.safe-error and their cataloged mappings; source-owned identical shapes are not redefined at each layer. No new representation decision is authorized.

## Slice Strategy

Vertical slice from public entrypoint to actual state/effect and failure behavior. Bounded retention and quota enforcement in wave 6.
...
| --- | --- | --- |
| AC-TICKET-006-DURABLE | ACC-SOWN-DURABLE in 04-verification.md | ai-harness/packages/harness/test/sandbox-durable-partitions.test.ts, ai-harness/packages/harness/test/local-durable-execution.test.ts, ai-harness/packages/harness/test/local-sandbox-workspace-isolation.test.ts |
| AC-TICKET-006-OWNER | ACC-SOWN-OWNER in 04-verification.md | ai-harness/packages/harness/test/sandbox-durable-partitions.test.ts, ai-harness/packages/harness/test/local-durable-execution.test.ts, ai-harness/packages/harness/test/local-sandbox-workspace-isolation.test.ts |
| AC-TICKET-006-BOUNDS | ACC-SOWN-BOUNDS in 04-verification.md | ai-harness/packages/harness/test/sandbox-durable-partitions.test.ts, ai-harness/packages/harness/test/local-durable-execution.test.ts, ai-harness/packages/harness/test/local-sandbox-workspace-isolation.test.ts |

Exact expected cases: Restart recovery for private/group files; concurrent commit/unjoined child/spawn writer conflicts; external owner rejection; failed copy/publication/restore; partition absent-at-checkpoint replay versus missing committed files; digest drift; suspension and terminal pin ordering.

## End-To-End Definition Coverage

CAP-SOWN-DURABLE / PATH-SOWN-DURABLE; CAP-SOWN-OWNER / PATH-SOWN-OWNER; CAP-SOWN-BOUNDS / PATH-SOWN-BOUNDS map to ai-harness/specs/36-sandbox-ownership-and-administration/02-capabilities/capability-inventory.md and 03-flows/e2e-coverage.md. Those rows fix actor, reachable entrypoint, data/state, side effects, permissions, errors/recovery, owner/final state and observability. This ticket covers the implementation approach above; no frontend/client screen or new transport is introduced.

## Operational Path Coverage

Include the matching failure/recovery cases in 04-verification.md: Restart recovery for private/group files; concurrent commit/unjoined child/spawn writer conflicts; external owner rejection; failed copy/publication/restore; partition absent-at-checkpoint replay versus missing committed files; digest drift; suspension and terminal pin ordering. Operator/provider actions outside default commands stay blocked until separately authorized. Cleanup remains retryable and never reports partial work as completed.
