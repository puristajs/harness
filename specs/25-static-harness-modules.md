...
The former reusable-module builders, registration callback, provenance, and
public builder-state authoring are removed. Reusable composition uses immutable
`defineCatalog(...)` values. Package-family
