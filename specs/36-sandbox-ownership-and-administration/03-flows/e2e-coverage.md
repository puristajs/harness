...
| --- | --- | --- | --- | --- | --- |
| PATH-SOWN-POLICY | Author; agent/workflow definition or child call | Policy to partition; mount files | Literal/runtime validation; child borrower cannot delete parent | Selected partition; no group labels in metrics | ACC-SOWN-POLICY |
