...
| --- | --- | --- | --- | --- |
| CAP-GA-CALLBACKS | Schema-directed native tools and callback inference | core | direct definition API | CTR-GA-CALLBACKS |
...
| CAP-GA-REQUIREMENTS | Provider-neutral interceptor graph preflight | core | definition composition | CTR-GA-BINDING, CTR-GA-ERRORS |
